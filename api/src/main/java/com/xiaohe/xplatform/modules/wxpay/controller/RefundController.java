...
import com.xiaohe.xplatform.modules.wxpay.entity.WxRefundInfoEntity;
import com.xiaohe.xplatform.modules.wxpay.util.common.PayUtils;
...
//    private WxRefundInfoService wxRefundInfoService;
    ...
    Map<String, Object> refund(String openid, String orderId, HttpServletRequest request) {
        ...
        String key = Constant.MCH_KEY;//mch_key
